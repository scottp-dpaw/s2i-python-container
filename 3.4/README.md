...
The RHEL image is available in the [Red Hat Container Catalog](https://access.redhat.com/containers/#/registry.access.redhat.com/rhscl/python-34-rhel7)
as registry.access.redhat.com/rhscl/python-34-rhel7.
The CentOS image is then available on [Docker Hub](https://hub.docker.com/r/centos/python-34-centos7/)
as centos/python-34-centos7. 
...
Usage
---------------------
To build a simple [python-sample-app](https://github.com/sclorg/s2i-python-container/tree/master/3.4/test/setup-test-app) application
...
* **APP_MODULE**
    ...
    [setup-test-app](https://github.com/sclorg/s2i-python-container/tree/master/3.4/test/setup-test-app).
